...
c.push(TODO('Add one sentence giving the phone model and the lighting conditions, for example “All photographs were taken on a <model> under indoor domestic lighting.” Both belong in the record because they are part of what makes this set different from the source datasets. The consent position is covered by the separate ethics form.'));
...
c.push(T([1800, 1600, 2000, 1300, 1600, 1700], [
  ...
  ['s2_plain', 'Healthy', 'Foot Wound', 'no', '0.6376', 'abstained'],
  ['s2_patterned', 'Healthy', 'Healthy', 'yes', '0.9058', 'answered'],
...
c.push(T([2600, 1600, 1700, 2600], [
  ...
  ['Plain background', '4 of 5', '80.0%', '37.6%  to  96.4%'],
  ['Patterned background', '2 of 5', '40.0%', '11.8%  to  76.9%'],
...
c.push(P('Photographs against a plain background were classified correctly four times out of five, and photographs against a patterned background twice out of five. Because each subject appears under both conditions, the appropriate test is McNemar’s exact test on the five pairs rather than a comparison of the two proportions. Four of the five pairs disagree, three of them in favour of the plain background, which gives an exact two-sided p-value of 0.6250.'));
c.push(P('The difference is therefore not statistically significant, and it is worth being precise about why that result was never available: with five pairs the smallest two-sided p-value attainable is 0.0625, so this design cannot reach significance whatever the outcome. The observation is reported as an observation with a plausible mechanism, not as a finding. A patterned background places edge and texture structure in the region around the foot, which is the kind of incidental detail that Section 5.7.3 showed the models can read to some degree. Establishing the effect would need roughly twenty to thirty pairs.'));
